...
class Notion_To_WordPress_Admin {
    ...
    public function handle_get_cache_stats() {
        ...
        try {
            ...
            // 添加数据库查询缓存统计
            $db_cache_stats = Notion_Import_Coordinator::get_cache_performance_stats();
    ...
    public function get_comprehensive_performance_data(): array {
        ...
        try {
            ...
            if (class_exists('Notion_Import_Coordinator')) {
                $pagination_stats = Notion_Import_Coordinator::get_pagination_stats();
            }
    ...
    private function reset_all_performance_stats(): void {
        try {
            ...
            // 重置分页统计
            if (class_exists('Notion_Import_Coordinator')) {
                Notion_Import_Coordinator::reset_pagination_stats();
                Notion_Import_Coordinator::reset_image_download_stats();
            }
